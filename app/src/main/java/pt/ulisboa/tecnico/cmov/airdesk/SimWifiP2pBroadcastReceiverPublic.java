 ...
 */
public class SimWifiP2pBroadcastReceiverPublic extends BroadcastReceiver {

    private OwnPrivateWorkspacesListActivity mActivity;

    public SimWifiP2pBroadcastReceiverPublic(OwnPrivateWorkspacesListActivity activity) {
        super();
