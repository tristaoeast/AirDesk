 ...
 */
public class SimWifiP2pBroadcastReceiverPrivate extends BroadcastReceiver {

    private OwnPrivateWorkspacesListActivity mActivity;

    public SimWifiP2pBroadcastReceiverPrivate(OwnPrivateWorkspacesListActivity activity) {
        super();
