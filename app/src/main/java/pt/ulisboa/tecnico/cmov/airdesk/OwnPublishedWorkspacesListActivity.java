...
//        Toast.makeText(this, "Back button pressed", Toast.LENGTH_LONG).show();
    ...
    protected void setupWsList() {
        ...
        _listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(OwnPublishedWorkspacesListActivity.this, OwnPublishedWorkspaceActivity.class);
    ...
    public void newOwnPublishedWorkspace(final View view) {
                ...
                .setPositiveButton("Create", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        if (oprivws.contains(name)) {
                            Toast.makeText(OwnPublishedWorkspacesListActivity.this, "Workspace with same name already exists. Choose different name", Toast.LENGTH_LONG).show();
                            newOwnPublishedWorkspace(view);
                            return;
                        } else {
                            oprivws.add(name);
