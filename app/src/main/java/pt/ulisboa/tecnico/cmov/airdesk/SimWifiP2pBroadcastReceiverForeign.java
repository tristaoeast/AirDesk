 ...
 */
public class SimWifiP2pBroadcastReceiverForeign extends BroadcastReceiver {

    private ForeignWorkspacesListActivity mActivity;

    public SimWifiP2pBroadcastReceiverForeign(ForeignWorkspacesListActivity activity) {
        super();
