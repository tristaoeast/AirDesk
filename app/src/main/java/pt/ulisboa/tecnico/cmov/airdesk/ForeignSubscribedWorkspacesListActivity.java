 ...
 */
public class ForeignSubscribedWorkspacesListActivity extends ActionBarActivity {
    ...
    protected void setupWsList() {
        ...
        _listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ForeignSubscribedWorkspacesListActivity.this, ForeignSubscribedWorkspacesListActivity.class);
...
//                Toast.makeText(WorkspacesActivity.this,groupPosition+" "+childPosition,Toast.LENGTH_LONG).show();
                ...
                if (0 == groupPosition) {
                    if (0 == childPosition) {
                        intent = new Intent(ForeignSubscribedWorkspacesListActivity.this, OwnPrivateWorkspacesListActivity.class);
                        intent.putExtra("LOCAL_USERNAME", _localUsername);
                        startActivity(intent);
                    } else if (1 == childPosition) {
                        intent = new Intent(ForeignSubscribedWorkspacesListActivity.this, OwnSharedWorkspacesListActivity.class);
                        intent.putExtra("LOCAL_USERNAME", _localUsername);
                        startActivity(intent);
                    } else if (2 == childPosition) {
                        intent = new Intent(ForeignSubscribedWorkspacesListActivity.this, OwnPublishedWorkspacesListActivity.class);
                        intent.putExtra("LOCAL_USERNAME", _localUsername);
                        startActivity(intent);
                    }
                    ...
                    if (0 == childPosition) {
                        ...
                        intent = new Intent(ForeignSubscribedWorkspacesListActivity.this, ForeignSharedWorkspacesListActivity.class);
                        intent.putExtra("LOCAL_USERNAME", _localUsername);
                        startActivity(intent);
                    } else if (1 == childPosition) {
                        intent = new Intent(ForeignSubscribedWorkspacesListActivity.this, ForeignSubscribedWorkspacesListActivity.class);
                        intent.putExtra("LOCAL_USERNAME", _localUsername);
                        startActivity(intent);
                    }
                }
