    ...
    protected void setupWsList() {
        ...
        _listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ForeignSharedWorkspacesListActivity.this, ForeignSharedWorkspacesListActivity.class);
...
//                Toast.makeText(WorkspacesActivity.this,groupPosition+" "+childPosition,Toast.LENGTH_LONG).show();
                ...
                if (0 == groupPosition) {
                    if (0 == childPosition) {
                        intent = new Intent(ForeignSharedWorkspacesListActivity.this, OwnPrivateWorkspacesListActivity.class);
                        intent.putExtra("LOCAL_USERNAME", _localUsername);
                        startActivity(intent);
                    } else if (1 == childPosition) {
                        intent = new Intent(ForeignSharedWorkspacesListActivity.this, OwnSharedWorkspacesListActivity.class);
                        intent.putExtra("LOCAL_USERNAME", _localUsername);
                        startActivity(intent);
                    } else if (2 == childPosition) {
                        intent = new Intent(ForeignSharedWorkspacesListActivity.this, OwnPublishedWorkspacesListActivity.class);
                        intent.putExtra("LOCAL_USERNAME", _localUsername);
                        startActivity(intent);
                    }
                    ...
                    if (0 == childPosition) {
                        ...
                        intent = new Intent(ForeignSharedWorkspacesListActivity.this, ForeignSharedWorkspacesListActivity.class);
                        intent.putExtra("LOCAL_USERNAME", _localUsername);
                        startActivity(intent);
                    } else if (1 == childPosition) {
                        intent = new Intent(ForeignSharedWorkspacesListActivity.this, ForeignSubscribedWorkspacesListActivity.class);
                        intent.putExtra("LOCAL_USERNAME", _localUsername);
                        startActivity(intent);
                    }
                }
